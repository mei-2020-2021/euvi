...
router.post('/', async function (req, res) {
  ...
  const contentSoul = await Content.create({
    Title: 'Soul',
    ReleaseYear: '2021',
    Sinopse: 'A musician who has lost his passion for music is transported out of his body and must find his way back with the help of an infant soul learning about herself.s',
    ImageUrl:
  ...
  const contentCoco = await Content.create({
    Title: 'Coco',
    ReleaseYear: '2017',
    Sinopse: "Aspiring musician Miguel, confronted with his family's ancestral ban on music, enters the Land of the Dead to find his great-great-grandfather, a legendary singer.",
    ImageUrl:
  ...
  const contentGarfield= await Content.create({
    Title: 'Garfield',
    ReleaseYear: '2004',
    Sinopse: "Jon Arbuckle buys a second pet, a dog named Odie. However, Odie is then abducted and it is up to Jon's cat, Garfield, to find and rescue the canine.",
    ImageUrl:
      'https://m.media-amazon.com/images/M/MV5BMTIzMTc1OTUxOV5BMl5BanBnXkFtZTYwNTMxODc3._V1_.jpg',
    TrailerUrl: 'https://www.youtube.com/watch?v=GV5y4yTDtBI',
    ImdbRating: 5.0,
    ContentTypeId: 1
  });
  const contentCats= await Content.create({
    Title: 'Cats',
    ReleaseYear: '2019',
    Sinopse: "A tribe of cats called the Jellicles must decide yearly which one will ascend to the Heaviside Layer and come back to a new Jellicle life.",
    ImageUrl:
    ...
    TrailerUrl: 'https://www.youtube.com/watch?v=gq50F-IDXDc',
    ImdbRating: 2.8,
    ContentTypeId: 1
  });
  const contentNotebook= await Content.create({
    Title: 'The Notebook',
    ReleaseYear: '2004',
    Sinopse: "A poor yet passionate young man falls in love with a rich young woman, giving her a sense of freedom, but they are soon separated because of their social differences.",
    ImageUrl:
  ...
  const contentAvengers= await Content.create({
    ...
    TrailerUrl: 'https://www.youtube.com/watch?v=udKE1ksKWDE',
    ImdbRating: 8.0,
    ContentTypeId: 1
  });
  const contentHangover= await Content.create({
    Title: 'The Hangover',
    ReleaseYear: '2009',
    Sinopse: "Three buddies wake up from a bachelor party in Las Vegas, with no memory of the previous night and the bachelor missing. They make their way around the city in order to find their friend before his wedding.",
    ImageUrl:
  ...
  const contentTCOTW= await Content.create({
    ...
    TrailerUrl: 'https://www.youtube.com/watch?v=5P8R2zAhEwg',
    ImdbRating: 6.8,
    ContentTypeId: 1
  });
  const contentConjuring= await Content.create({
    Title: 'The Conjuring',
    ReleaseYear: '2013',
    Sinopse: "Paranormal investigators Ed and Lorraine Warren work to help a family terrorized by a dark presence in their farmhouse.",
    ImageUrl:
